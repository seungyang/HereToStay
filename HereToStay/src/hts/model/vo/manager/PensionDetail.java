...
public class PensionDetail  {
   ...
   private List<MongoVO> phothList;
   
   

   public PensionDetail(String penId, String penName, String penAddr, String penAddr2, String penOpt, String penIntro,
         String penLoad, String penNoti, String penShot, String penEhot, String penStatus, String ownId,
         String penDate, String romId, String romName, String romType, String romPeople, String romIntro,
         int romCost, String romStatus, String romOpt, String ownName, String ownPwd, String ownMail, String ownTel,
         String ownBank, String ownAcc, String ownLic, List<MongoVO> phothList) {
      super();
      this.penId = penId;
   ...
   public List<MongoVO> getPhothList() {
      return phothList;
   }
   public void setPhothList(List<MongoVO> phothList) {
      this.phothList = phothList;
   }

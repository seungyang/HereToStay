...
<%@page import="hts.model.vo.manager.PensionDetail"%>
...
.p-item-page-lb{width:100%}
.p-item-padding{width:500px;}
.bx-controls-direction{width:500px;}
...
<!-- 				<div class="typography-heading">펜션정보 상세보기</div> -->
				...
				<div class="shortcodes-left">
					<!-- // accordeon // -->
 	 				...
 	 				<div class="p-item-padding">
    					...
    					<c:forEach items="${plist}" var="plist" varStatus="status" > 
  								...
  								<img id='big' alt="" src="/uploadPhoto/${plist.fullname}"/>  
  										</div>								
		  					</c:forEach>
    					</div>
  					</div>
  				...
  				<!-- /////선택한 펜션의 정보를 불러오는 부분/////  -->
  						 <c:forEach items="${detail}" begin="1" end="1" var="d" varStatus="status" > 
									...
									<div class="blockqoute-tp-a">옵     션  >> ${d.penOpt}</br></br></div>
									<div class="blockqoute-tp-a">주인장 소개글 </div> <hr>${d.penIntro}<hr></br></br>
									<div class="blockqoute-tp-a">확인 및 기타 사항 </div><hr>${d.penNoti}<hr></br></br>
				...
				<!-- /////선택한 펜션의  사장 정보를 불러오는 부분/////  -->					
							<c:forEach items="${detail}" begin="1" end="1" var="d" varStatus="status" >
								...
								<div class="blockqoute-tp-a">사업자등록증  </div></br></br>
...
<!-- 										<div id="registPic"> -->
<%-- 												<img alt="" src="/uploadPhoto/${d.fullname} width="400" height="450" /> --%>
<!-- 										</div> -->
										<c:forEach items="${detail}" begin="1" end="1" var="d" varStatus="status" >
										<div id="registPic"><img alt=""  src="/uploadPhoto/${d.ownLic}" width="400" height="450"/></div>
										</c:forEach>
									</div>
								</div>
							<!-- \\ -->
					...
					<!-- /////선택한 펜션의  객실 정보를 불러오는 부분/////  -->	
								...
								<div class="blockqoute-tp-a">객실소개글  </div><hr>${d.romIntro}<hr></br></br>
								<div class="blockqoute-tp-a">편 의 시 설  </div><hr>${d.romOpt}<hr></br></br>

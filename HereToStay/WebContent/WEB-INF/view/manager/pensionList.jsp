...
<style type="text/css">
img{display: block;}
.table-a.light tr th, .table-a.light tr td{border:1px solid #e6e6e6;}
.counters-row-i span {
   margin-top: 30px;
}
#divDetail{
...
/* .shortcodes-right > .table-a{ */
/* 	table-layout:fixed; */
/* } */

/* .table-a th{text-align:center;} */
/* .shortcodes-right > .table-a td{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;} */
 .shortcodes-right > .table-a td{padding:13px 14px 13px 14px;} 
...
.table-a th{text-align:center;}
.table-a td{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
      ...
      <div class="inner-breadcrumbs">
         <div class="content-wrapper">
            ...
            <div class="breadcrumbs">
                 <a href="/manager/pensionList.do">관리자페이지</a> / <span>펜션관리</span>
               </div>
               <div class="clear"></div>
            </div>      
      </div>
            ...
            <div class="shortcodes-block">
               ...
               <!--  //start 재고리스트// -->
                  <div class="shortcodes-left" style="">
                     <div><span><b class='tabletitle'>재고리스트</b></span></div>
                     <div><span><a href="/manager/storageDetail.do"><b class='more'>더보기</a></b></span></div>
                     <div class="accordion">
                        <table id="stotable" class="table-a" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                             <th align="center" style="width:9%;">순번</th>
                           <th align="center" style="width:20%;">펜션이름</th>
                           <th align="center" style="width:48%;">주소</th>
                           <th align="center" style="width:20%;">현재상태</th>
                           </tr>
                           <!-- 재고리스트가 없을 시  -->
                           <c:choose>
...
<!--                                           </form> -->
                 ...
                 <div><span><b class='tabletitle'>허가리스트</b></span></div>
                 <div><span><a href="/manager/pensionMore.do"><b class='more'>더보기</a></b></span></div> 
                     <table class="table-a light">
                        <tr>
                           <th align="center" style="width:9%;">순번</th>
                           <th align="center" style="width:20%;">펜션이름</th>
                           <th align="center" style="width:39%;">주소</th>
                           <th align="center" style="width:18%;">요청날짜</th>
                           <th align="center" style="width:13%;">현재상태</th>
                        </tr>
        ...
        <c:otherwise>
         ...
         <tr height="25">
            ...
            <td class="penName" style="cursor:pointer" align="center">${a.penStatus}</td>  
               ...
               <!-- // counters // -->
               <div class="counters">
                  <div class="typography-heading fly-in"><b class='tabletitle'>허가 요청 현황</b></div>

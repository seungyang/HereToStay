...
/* start 아코디언 CSS */
			...
			.accordion-toggle.active:after{position:absolute;right:0;top:17px;width:0;height:0;border-bottom:5px solid #f00;border-left:5px solid rgba(0,0,0,0);border-right:5px solid rgba(0,0,0,0);}
				...
				<div class="inner-breadcrumbs">
					<div class="content-wrapper">
						...
						<div class="breadcrumbs">
							<a href="/manager/pensionList.do">관리자페이지</a> / <span>재고 리스트</span>
						</div>
						<div class="clear"></div>
					</div>
				</div>
			...
			<div class="content-wrapper">
				<div class="shortcodes-block">
					...
					<div class="tables">
						...
						<span><b class="tabletitle">재고리스트</b></span>
						 <!-- 펜션이름검색 -->
                     <form id="writeForm" action="/manager/stoSearch.do" method="get">
                    <br/><br/>
                     <div class='searchPen'>
                     <input type="text" id="penName1"value="" placeholder="펜션이름검색" name="penName" style="text-transform: none; padding: 2px; border: 1px solid #dbdada;" >
											...
											<tr class="accordion-content">
												<td colspan="4">
													...
													<div class="divDetail">
														...
														<form id="tncSubmit" action="/manager/tncUpdate.do" method="post">
															<div class="divDetail1">
																...
																<div class="p-item-details">
																	...
																	<div class="p-item-details-i">
																		...
																		<input type="hidden" size='3' name="stoBath" value="${sto.stoBath}"/>
																		<input type="hidden" class ="ImsiTnc" size='3' name="stoImsi" id="ImsiTnc" value="${sto.stoTnc}"/>
																			<input type="text" class ="stoTnc" size='3' name="stoTnc" id="stoTnc" />
																		</div>
																		<div class="clear"></div>
																	</div>

																	<input type="button" id = "tncOrder" class="storageOrder" value="주문하기">
																</div>
															...
															<div class="divDetail1">
																...
																<div class="p-item-details">
																	...
																	<div class="p-item-details-i">
																		...
																		<input type="hidden" size='3' name="stoTnc" value="${sto.stoTnc}"/>
																			<input type="hidden" size='3' name="stoImsi" class="ImsiBath" id="ImsiBath"  value="${sto.stoBath}"/>	
																			<input type="text" size='3' name="stoBath" class="stoBath" id="stoBath" />
																		</div>
																		<div class="clear"></div>
																	</div>
																	<input type="button" id = "bathOrder" class="storageOrder1" value="주문하기">
																</div>
	...
	<script>
	 ...
	 function fn_movePage(val){
      ...
      $(document).ready(function() {
         ...
         $(".storageOrder").each(function(){
        	 $(this).click(function() {
         		  var inputData = parseInt($(this).parent().children().children().children(".stoTnc").val());

            		 var hiddenData = parseInt($(this).parent().children().children().children(".ImsiTnc").val());

        		 if(isNaN(inputData)){
        			 alert('숫자를 입력해주세요');
        		 }else if(inputData<0){
            		 alert("양수를 입력해주세요");
            	 }else if(inputData + hiddenData > 20){
            		 alert("최대 개수를 초과 하였습니다. 다시입력해주세요");
            	 }else{
//             		 $("#tncSubmit").submit();
            		 $(this).parent().parent().parent("#tncSubmit").submit();
            	 }
        	});
         });
        	 
        	 $(".storageOrder1").each(function(){
            	 $(this).click(function() {
            		 var inputData = parseInt($(this).parent().children().children().children(".stoBath").val());
   
            		 var hiddenData = parseInt($(this).parent().children().children().children(".ImsiBath").val());
            		 ...
            		 if(isNaN(inputData)){
                		 ...
                		 $(this).parent().parent().parent("#bathSubmit").submit();
                	 }
            	});
        	 });

...
<head>
  ...
  <link href='http://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700&amp;subset=latin,cyrillic' rel='stylesheet' type='text/css'>
	...
	.masterChat img{position:absolute; top:0; left:0;}
	.masterChat,
	...
	var chatapp = {
		append: function(msg){
			...
			}else if(msg.message.match(/zSer@/)) {
				var msg = msg.message.split('@');
				$("#chatmessage").append("<div class='userChat' style='text-align: right; margin-left:10px;'><p>" + msg[1] + "</p></div>");
			} else {
				var msg = msg.message.split('@');
				$("#chatmessage").append("<div class='masterChat'><img src='/img/user.png' alt='user프로필'><p>" + msg[1] + "</p></div>");				
			}
		...
		<div class="inner-breadcrumbs" style="margin-bottom : 0px;">
			<div class="content-wrapper">
				...
				<div class="breadcrumbs">
        			<a href="/manager/pensionList.do">Home</a> /  <span>실시간 문의사항</span>
      			</div>
      			<div class="clear"></div>
      		</div>		
		</div>
	...
	<div class="contacts-page-holder">
 	<div class="contacts-page">
		...
		<div class="contacts-colls">
			...
			<form action="/member/qnaInsert.do" id="qnaSend" method="post" enctype="multipart/form-data">
				<div class="contacts-colls-r">
	  				<div class="contacts-colls-rb">
	  					...
	  					<div class="chatwrap">
	  						<img src="/img/manager/i_phone.png" alt="" >

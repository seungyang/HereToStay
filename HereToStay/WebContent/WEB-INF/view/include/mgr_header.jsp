...
<header id="top">
   ...
   <div class="header-b">
         ...
         <div class="mobile-menu">
            <nav>
               <ul>
                  ...
                  <li><a class="has-child" href="/manager/QnAList.do?mgrId=${sessionScope.id}">문의사항</a>
                  </li>
               </ul>
            </nav>   
         </div>
      ...
      <div class="wrapper-padding">
         <div class="header-logo"><a href="/manager/pensionList.do"><img alt="" src="/img/manager/logo.png" /></a></div>

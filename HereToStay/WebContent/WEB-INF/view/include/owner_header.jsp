...
<header id="top">
      ...
      <!-- // mobile menu // -------------------------------------------------------------------------------->
         <div class="mobile-menu">
            <nav>
               <ul>
                  <c:choose>
                        <c:when test="${sessionScope.ownId ne null }">
                           <li><a href="/owner/Step1Pension.do">펜션등록</a></li>
                           <li><a href="/owner/Step2Room.do">객실등록</a></li>
                           <li><a href="/owner/Reservation.do">예약현황</a></li>
                           <li><a href="/owner/getQnAList.do">문의사항</a></li>
                        </c:when>
                        <c:otherwise>   
                           ...
                           <li><span class="header-account m"><a href="/owner/Reservation.do">예약현황</a></span></li>
                           <li><span class="header-account m"><a href="/owner/getQnAList.do">문의사항</a></span></li>
                        </c:otherwise>
                  </c:choose>            
                  <c:choose>
                     <c:when test="${sessionScope.ownId ne null }">
                        <li>${sessionScope.ownId} 님 반갑습니다.</li>
      ...
      <div class="wrapper-padding">
         <div class="header-logo"><a href="/owner/Main.do"><img alt="" src="/img/logo.png" /></a></div>
               ...
               <ul>
                  <li><a href="#">펜션관리</a>
      	              <c:choose>
                           <c:when test="${sessionScope.ownId ne null }">
                           		<c:choose>
                           			<c:when test="${sessionScope.pensionStatus eq 'O' }">
                           				<ul>
                           				<li><a href="/owner/Step1Pension.do">펜션등록</a></li>
                              			</ul>
                           			</c:when>
                  ...
                  <c:choose>
                     <c:when test="${sessionScope.ownId ne null }">
                     	<c:choose>
                        	...
                        	<c:otherwise>
                        		<li><a href="/owner/Reservation.do?pageS=1">예약현황</a></li>                           		
                        	</c:otherwise>
                        </c:choose>
                     </c:when>
            	</c:choose>

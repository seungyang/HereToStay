            ...
            <table class="table table-bordered">
                <tbody>
                        ...
                        <td class="bd_r_none">
                            <div class="form-layer mb_24">
                                ...
                                <span class="form-body">
                                    <input class="form-control normal-size" type="text" name="romName" placeholder="이름을 입력하세요." value="">
                                </span>
                            </div>
                            <div class="form-layer mb_24">
                                ...
                                <span class="form-body">
										<div class="pull-left">
											...
											<div class="select-style small-size">
													<input class="form-control normal-size" type="text" name="romPeople" id="bunk_bed">
											</div>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="form-layer">
                                <textarea class="form-control textarea-layer"" rows="8" name="romIntro" placeholder="객실 내 침대 구성과, 전용 욕실 여부 등 객실 소개/구성을 자세히 기재해 주세요." ></textarea>
                            </div>
                        ...
                        <td class="bd_r_none">
                                        ...
                                        <div class="form-inline">
                                            <label data-role="price" class="radio-inline" style="margin-right:10px">
                                               	 결제요금 : <input name="romCost" data-role="price" class="form-control input-sm" type="text" value="0" style="width:90px"> 원
                                            </label>
                                       	</div>
...
<!--                 <button class="btn btn-default btn-submit btn-guest-room" type="button" onclick="deleteRoomInfo()" >삭제하기</button> -->
                &nbsp;&nbsp;&nbsp;
...
function submitRoomInfo() { // 저장하기
    ...
    if ($('#room-form input[name=romName]').val().length < 2) {
        alert('객실명은 2자 이상 입력해주세요.');

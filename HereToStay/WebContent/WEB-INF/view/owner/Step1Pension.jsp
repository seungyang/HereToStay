...
<head>
    ...
    <link href="/css/ownerfileUpload.css" rel="stylesheet" />
    ...
    <form class="form-horizontal" id="intro-form" method="post" action="/owner/Step2Room.do" name="intro"
        ...
        <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="bd_r_none">
                        <div class="form-layer mb_24">
                            ...
                            <input class="form-control normal-size" type="text" name="penName" placeholder="페션명을 입력하세요." value="" />
                            </span>
                        </div>
                        <div class="form-layer mb_24">
                            <span class="form-title">펜션 주소</span>
                            <span class="form-body">
                            <input class="form-control normal-size adr" id="input_roadAddress" type="text" name="penA1" readonly placeholder="업체 주소를 입력하세요." value="" />
                        ...
                        <div class="form-layer newline mb_24">
                            <span class="form-body">
                            <input class="form-control normal-size" type="text" name="penA2" placeholder="나머지 주소를 입력하세요." value="" />
                            </span>
                        </div>
                                            </td>
            ...
            <tr>
                        ...
                        <td colspan="2">
                            <div class="form-layer">
                                <textarea class="form-control textarea-layer" rows="6" name="penNoti" placeholder="기재된 숙소 정보 외에 게스트 숙지 사항을 기재해주세요." style="min-height:120px !important;height:120px !important"></textarea>
                            </div>
                            <span class="exam-button"> <i class="fa fa-angle-down" aria-hidden="true"></i></span>
                        ...
                        <td class="bd_r_none">
                            ...
                            <span class="form-body">
                                    <div class="peak-item form-inline mb_24">
                                        ...
                                        <input class="form-control middle-size datepicker" type="text" data-name="peak_start" data-role="datepicker" value="" readonly="readonly" name="penShot">
                                        <span class="range"> ~ </span>
                                        <input class="form-control middle-size datepicker" type="text" data-name="peak_end" data-role="datepicker" value="" readonly="readonly" name="penEhot">
										<!-- 성수기 삭제 버튼 비활성화 -->

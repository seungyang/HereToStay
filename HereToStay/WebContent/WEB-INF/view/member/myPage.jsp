		...
		<div class="inner-breadcrumbs">
			<div class="content-wrapper">
				...
				<div class="breadcrumbs">
        			<a href="/member/index_member.do">Home</a> / <span>마이페이지</span>
      			</div>
      			<div class="clear"></div>
      		</div>		
		</div>
...
<!-- 													                      	승용 -->
													                      <a href="/member/getReserve.do?resId=${item.resId}">
													                      <c:choose>
																			<c:when test="${item.photoList[0].fullname ne null}">
																				<img src="/uploadPhoto/${item.photoList[0].fullname}" style="height: 211px; width: 284px;">
																			</c:when>
																			<c:otherwise>
																				<img src="/img/lit-i-01.jpg">
																			</c:otherwise>
																		  </c:choose>
													                      </a>
													                  </div>
													...
													<p>
										                ...
										                <p class="small"> 내가 작성한 리뷰를 보여줍니다. </p> <br/>
												          <div class="padding">
												            ...
												            <div class="offer-slider-i catalog-i fly-in" style="height:240px">
																		<img src="/img/member/failPension.gif"></img>
																		<div class="clear"></div>
																		리뷰가 없습니다. 
																		</div>
												            </c:if>
												            ...
												            <div class="offer-slider-i catalog-i fly-in">
																			<a href="/member/pensionDetail.do?id=${item.penId}" class="offer-slider-img">
																				<c:choose>
																					<c:when test="${item.photoList[0].fullname ne null}">
																						<img src="/uploadPhoto/${item.photoList[0].fullname}" style="height:208px">
																					</c:when>
																					<c:otherwise>
																						<img src="/img/lit-i-01.jpg" style="height:208px">
																					</c:otherwise>
																				</c:choose>
												...
												<div class="tabs-content-i" style="margin-left: 70px;">
													<p>
										                ...
										                <p class="small"> 내가 한 문의들을 보여줍니다. </p> <br/>
												          ...
												          <div class="services fly-in" style="height:250px">
												          <img src="/img/member/failPension.gif"></img>
																		<div class="clear"></div>
																		문의사항이 없습니다. 
																	...
																	<!-- // -->
																		<div class="solutions-i">
																			...
																			<div class="solutions-img">
																				<c:choose>
																					<c:when test="${QnA.photoList[0].fullname ne null}">
																						<img src="/uploadPhoto/${QnA.photoList[0].fullname}" style="height: 206px; width: 280px;">
																					</c:when>
																					<c:otherwise>
																						<img src="/img/solution-01.jpg">
																					</c:otherwise>

...
<head>
  ...
  <link href='http://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700&amp;subset=latin,cyrillic' rel='stylesheet' type='text/css'>
	...
	.contacts-send{border-radius:20px; width:auto; position:absoltue; left:50px; bottom:10px; margin-left: 131px; margin-bottom: 4px; background:#FFC5D0; border:1px solid #fff}
	.masterChat{
		float:left;
	}
	.userChat{
	...
	.booking-form-i .textarea-wrapper textarea{height:22px; width:94%;}
	.contacts-colls-r{margin:0 0 0 407px;}
	.profile{position:absolute; left:0; top:0;}
	.masterChat,
	...
	$(function(){
		var chatAreaHeight = $("#scrollDiv").height();
	    var maxScroll = $("#chatmessage").height() - chatAreaHeight;
	    $("#scrollDiv").scrollTop(maxScroll);
	});
	...
	<div class="inner-page">
		<div class="inner-breadcrumbs" style="margin-bottom : 0px;">
			<div class="content-wrapper">
				<div class="page-title">실시간 문의사항</div>
				<div class="breadcrumbs">
        			<a href="/member/index_member.do">Home</a> /  <span>실시간 문의사항</span>
      			</div>
      			<div class="clear"></div>
      		</div>		
		</div>
			...
			<div class="contacts-colls-l">
				...
				<div class="contacts-colls-r">
	  				<div class="contacts-colls-rb">
	  					<div class="textwrap" id="scrollDiv" style="padding-top:35px; overflow-y:scroll">
					        <div class="textcontent" id="chatmessage"></div>
					    </div>
	  					<div class="chatwrap">
	  						<img src="/img/i_phone.png" alt="" >

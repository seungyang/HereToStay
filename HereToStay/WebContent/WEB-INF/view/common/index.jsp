...
<head>
  ...
  <style>
   ...
   .portfolio-holder{padding-top:220px;} 
	...
	.portfolio-three-colls .portfolio-i {
	    ...
	    margin-right: 0px;
	     ...
	     .portfolio-holder{padding-top:120px;} 
	 }
  </style>
</head>  
<body>  
...
<!------------------------------------------------------------ START OF 로그인 창 띄어주기 (사용자)------------------------------------------------------------>
                           <a href="#"  >Click Here</a>
<!------------------------------------------------------------- END OF 로그인 창 띄어주기 (사용자)---------------------------------------------------------- -->
                     </div>
                  </div>
               </div>
         ...
         <div class="portfolio-i photography">
            <div class="portfolio-i-img">   
               <div class="portfolio-i-over">
                  <div class="portfolio-i-over-a">
                     <div class="portfolio-i-over-b">
<!------------------------------------------------------------ START OF 로그인 창 띄어주기 (사장님)------------------------------------------------------------>
                           <a href="#" >Click Here</a>
<!------------------------------------------------------------- END OF 로그인 창 띄어주기 (사장님)---------------------------------------------------------- -->                                           
                     </div>
                  </div>
               </div>
